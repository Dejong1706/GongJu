...
export const UPDATES: Update[] = [
  {
    ...
    items: [
      ...
      { kind: "fix", text: "윷놀이 — 윷가락 그림이 나온 값과 다르게 멈춰 있던 문제" },
      { kind: "change", text: "윷놀이 — 판에 나간 말이 없을 때 백도가 나오면 한 번 쉬어요 (도로 바뀌지 않아요)" },
      {
        kind: "change",
        text: "강의 · 과제 · 할일 뱃지가 종류마다 한 색으로 바뀌었어요 — 어느 수업인지는 이름 앞 색 네모로 보여요",
      },
    ],
  },
  {
    ...
    items: [
      {
        kind: "fix",
        text: "윷놀이 말길과 규칙을 실제 윷놀이에 맞췄어요 — 오른쪽 위로 돌고, 출발점을 지나야 나요",
      },
      {
        kind: "change",
        text: "윷 · 모가 나오면 옮기지 않고 계속 던진 뒤, 나온 값 중에 골라 옮길 수 있어요",
      },
      {
        kind: "change",
        text: "던진 윷 칸에는 지금 던지는 사람 것만 보여요 — 차례가 넘어가면 비워져요",
      },
    ],
  },
  {
