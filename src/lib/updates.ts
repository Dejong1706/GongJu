...
export const UPDATES: Update[] = [
  {
    date: "2026-09-17",
    items: [
      { kind: "new", text: "가구 · 인형을 돌릴 수 있어요 — 옮기기를 누르고 가구 옆 ↺ ↻ 를 눌러요. 침대는 머리를 벽에 붙일 수 있어요" },
      ...
      { kind: "new", text: "👑 비싼 아이템 8개 — 왕관 · 요정 날개 · 캐노피 침대 · 공주 화장대 · 어항 · 밤하늘 창문 · 궁전 벽지 · 왕실 카펫" },
      { kind: "new", text: "어항 물고기가 헤엄치고, 밤하늘 창문 별이 반짝이고, 요정 날개가 팔랑여요" },
      { kind: "new", text: "비싼 아이템은 상점에서 금테 칸으로 따로 보여요" },
      { kind: "new", text: "🏰 왕궁 세트 — 왕실 깃발 · 왕좌 · 유니콘 인형 · 장미 꽃병" },
      { kind: "new", text: "💜 1,000포인트 창문 2개 — 궁전 창문 · 발코니 창문. 상점에서 보라색 칸으로 보여요" },
      { kind: "change", text: "포인트를 더 줘요 — 스티커 25 · 토익 만점 50 · 타이머 25분 15. 부지런한 날이면 하루 180점쯤 모여요" },
      { kind: "change", text: "상점에서 비싼 것부터 보여요" },
      { kind: "change", text: "상점 등급이 셋이 됐어요 — 500포인트부터 골드(금테), 1,000포인트부터 프리미엄(보라)" },
      { kind: "change", text: "궁전 벽지 · 왕실 카펫이 1,000포인트 프리미엄이 됐어요" },
      { kind: "change", text: "대리석 바닥을 뺐어요" },
      { kind: "new", text: "🌸 꽃 타일 바닥 — 금 줄눈 크림 타일에 분홍 꽃 (골드)" },
      { kind: "new", text: "금실 줄무늬 벽지 — 연분홍 띠에 금실과 진주 (골드)" },
      { kind: "change", text: "궁전 벽지가 왕실 카펫과 어울리게 크림 · 진홍 · 금으로 바뀌었어요" },
      { kind: "change", text: "캐노피 침대가 750포인트로 내려갔어요" },
      { kind: "new", text: "🛏️ 왕실 침대 — 금 기둥 · 진홍 지붕 · 비치는 망사 커튼 · 흰 이불 (1,000포인트)" },
